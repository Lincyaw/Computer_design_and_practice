        ...
        begin 
            ...
            6'b000000:
                begin
                    ...
                    else begin NPC_MODE <= `Normal;end
                end
            `ins_j:     begin  NPC_MODE <= `J_Jal; end 
            `ins_jal:   begin  NPC_MODE <= `J_Jal; end//regmode5是把{PC+4}写到$31里
            default:    begin  NPC_MODE <= `Normal; end
            endcase
        end
        `sexecute: 
        begin 
            ...
            `ins_beq:   begin ALU = `SUB; ALU_MODE = `ALU_MODE0; NPC_MODE = `Beq; Sel_Sign = 1; end
            `ins_bne:   begin ALU = `SUB; ALU_MODE = `ALU_MODE0; NPC_MODE = `Bne; Sel_Sign = 1; end
            `ins_bgtz:  begin ALU = `SUB; ALU_MODE = `ALU_MODE0; NPC_MODE = `Bgtz;Sel_Sign = 1; end
            default:    begin NPC_MODE = `Normal; end
            endcase
        end
        `smem:     
